...
const SignUpPage = () => {
  ...
  // Check the validation of the Form and send the Notificaiton
  const validateForm = () => {
  ...
  return (
    <div className="grid min-h-screen items-center justify-center lg:grid-cols-2">
      {/* Left side Form */}
      <div className="flex flex-col items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md items-center justify-center space-y-8">
          {/* LOGO */}
